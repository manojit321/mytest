...
import com.manoj.macawplayer.CopyOfSwipeActivity.TabFactory;
 ...
 * @author mwho
 */
public class CopyOfSwipeActivity extends FragmentActivity implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
 
    private TabHost mTabHost;
    private ViewPager mViewPager;
    private LinkedHashMap<String, TabInfo> mapTabInfo = new LinkedHashMap<String, CopyOfSwipeActivity.TabInfo>();
    ...
    private void initialiseTabHost(Bundle args) {
        ...
        CopyOfSwipeActivity.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab1").setIndicator("Albums"), ( tabInfo = new TabInfo("Tab1", AlbumFragment.class, args)));
        this.mapTabInfo.put(tabInfo.tag, tabInfo);
        CopyOfSwipeActivity.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab2").setIndicator("Artist"), ( tabInfo = new TabInfo("Tab2", ArtistFragment.class, args)));
        this.mapTabInfo.put(tabInfo.tag, tabInfo);
        CopyOfSwipeActivity.AddTab(this, this.mTabHost, this.mTabHost.newTabSpec("Tab3").setIndicator("Songs"), ( tabInfo = new TabInfo("Tab3", SongFragment.class, args)));
        this.mapTabInfo.put(tabInfo.tag, tabInfo);
     ...
     * @param args
     */
    private static void AddTab(CopyOfSwipeActivity activity, TabHost tabHost, TabHost.TabSpec tabSpec, TabInfo tabInfo) {
