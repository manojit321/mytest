 ...
 */
public class CopyOfSongCustomFragment extends Fragment {
     ...
     */
    public CopyOfSongCustomFragment() {}
...
*/    /**
    ...
    private class ImageAdapter extends BaseAdapter {
        ...
        public int getCount() {
            ...
            return songsListData.size() + mNumColumns;
        }

        @Override
        public Object getItem(int position) {
            return position < mNumColumns ?
                    null : songsListData.get(position - mNumColumns);
        }
...
*/
            ...
            song = songsListData.get(position);
