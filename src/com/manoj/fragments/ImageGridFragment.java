...
public class ImageGridFragment extends Fragment implements AdapterView.OnItemClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		if(songsList1!=null && this.songsList1.isEmpty())
		 songsList1=si.getAlbumsWithArt(getActivity().getContentResolver());
			...
			for (int i = 0; i < songsList1.size(); i++) {
				...
				song1.put("KEY_ALBUM", songs.getAlbum());
    ...
    private class ImageAdapter extends BaseAdapter {
        ...
        public Object getItem(int position) {
            return position < mNumColumns ?
                    null : tempSongsListData.get(position - mNumColumns);
        }
        ...
        public View getView(int position, View convertView, ViewGroup container) {
            ...
            mImageFetcher.loadImage( (Uri) song.get("KEY_THUMB_URL"), imageView);
            ...
            imageView.setOnClickListener(new View.OnClickListener(){
    			...
    			//// getting listitem index
                 ...
                 // Starting new intent
                    ...
                    if(tempSongsListData.isEmpty())
                    	in.putExtra("album", tempSongsListData.get(songIndex).get("KEY_ALBUM").toString());
                    else
                    	in.putExtra("album", tempSongsListData.get(songIndex).get("KEY_ALBUM").toString());
